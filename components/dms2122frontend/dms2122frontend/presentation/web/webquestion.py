...
class WebQuestion():
    ...
    """
    @staticmethod
    def create_question( backend_service: BackendService, questionName: str, description:str, questionAnswer:str, questionAnswer2:str, questionAnswer3:str, correctAnswer: int,puntuation:float, penalty:float) -> Optional[Dict]:
        """ Creates the new question requested by the teacher.
        Args:
            - auth_service (BackendService): The authentication service.
        ...
        response: ResponseData = backend_service.create_question(
            session.get('token'), questionName, description, questionAnswer, questionAnswer2, questionAnswer3, correctAnswer, puntuation, penalty)
